...
# Add custom CSS for background color and dataframe styling
st.markdown(
    """
    <style>
    .stApp {
...
if 'history' in st.session_state and st.session_state['history']:
    ...
    fig.update_layout(
        paper_bgcolor='#87AECF',
        plot_bgcolor='#87AECF',
        xaxis=dict(title='Timestamp', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
        yaxis=dict(title='Result', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
    ...
    with col4:
        ...
        fig2.update_layout(
            paper_bgcolor='#87AECF', 
            plot_bgcolor='#87AECF',
            xaxis=dict(title='Age', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            yaxis=dict(title='Result', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            font=dict(color='black')
        )
    ...
    with col5:
        ...
        fig3.update_layout(
            paper_bgcolor='#87AECF',
            plot_bgcolor='#87AECF',
            xaxis=dict(title='Serum Cholesterol', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            yaxis=dict(title='Count', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            font=dict(color='black')
        )
    ...
    with col6:
        fig4 = px.box(history_df, y='Max Heart Rate', title='Max Heart Rate Distribution', color='Gender',color_discrete_map={'Female': 'orange', 'Male': 'green'})
        fig4.update_layout(
            paper_bgcolor='#87AECF',
            plot_bgcolor='#87AECF',
            yaxis=dict(title='Max Heart Rate', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            font=dict(color='black')
        )
    ...
    with col8:
        fig6 = px.scatter(history_df, x='Resting Blood Pressure', y='Max Heart Rate', color='Gender', title='Resting Blood Pressure vs. Max Heart Rate', labels={'Resting Blood Pressure': 'Resting Blood Pressure', 'Max Heart Rate': 'Max Heart Rate'}, color_discrete_map={'Female': 'orange', 'Male': 'green'})
        fig6.update_layout(
            paper_bgcolor='#87AECF',
            plot_bgcolor='#87AECF',
            xaxis=dict(title='Resting Blood Pressure', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            yaxis=dict(title='Max Heart Rate', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            font=dict(color='black')
        )
    ...
    with col9:
        fig7 = px.violin(history_df, y='Oldpeak', x='ST Slope', color='Gender', box=True, points="all", title='Oldpeak Distribution by ST Slope', color_discrete_map={'Female': 'orange', 'Male': 'green'})
        fig7.update_layout(
            paper_bgcolor='#87AECF',
            plot_bgcolor='#87AECF',
            xaxis=dict(title='ST Slope', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            yaxis=dict(title='Oldpeak', color='black', tickfont=dict(color='black'), title_font=dict(color='black')),
            font=dict(color='black')
        )
